...
import { ShieldCheck } from "lucide-react"; // Menggunakan ShieldCheck biar senada dengan tema kesehatan
...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen w-full bg-slate-100 overflow-hidden relative font-sans flex items-stretch">
      ...
      {/* --- SISI KIRI (Branding & Logo sebagai Navigasi) --- */}
      ...
      <div className="flex-1 bg-white/60 backdrop-blur-xl border-l border-white/20 flex flex-col items-center justify-center p-12 relative">
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-4xl font-black text-slate-950 mb-2 tracking-tighter">
              Selamat Datang
            </h2>
            <p className="text-slate-600 opacity-90 leading-relaxed">
