  ...
  return (
    <div className="h-screen w-full bg-slate-100 overflow-hidden relative font-sans flex items-stretch">
      ...
      <div className="relative flex-[1.2] bg-linear-to-br from-[#2e66a2] to-[#254292] overflow-hidden flex flex-col justify-between p-12">
        <div style={{ width: '600px', height: '600px', borderRadius: '50%' }} className="absolute -top-32 -left-32 bg-[#3d60c1]/40 blur-3xl pointer-events-none z-0 animate-pulse"></div>
        <div style={{ width: '500px', height: '500px', borderRadius: '50%' }} className="absolute -bottom-40 -right-40 bg-sky-700/30 blur-3xl pointer-events-none z-0"></div>
        ...
        <div className="relative z-10 space-y-8">
          <div className="max-w-xl">
            <h1 className="text-5xl font-black text-white leading-[1.1] tracking-tighter">Kesehatan Anda, <br /> Prioritas Utama Kami.</h1>
            <p className="text-lg text-white/80 mt-4 leading-relaxed max-w-md">HealthLogia menggunakan AI untuk membantu deteksi dini kondisi kesehatan Anda.</p>
          </div>
        ...
        <p className="relative z-10 text-xs text-white/40 font-medium">© 2026 HealthLogia AI Platform. Professional Screening Tool.</p>
      </div>
      ...
      <div className="flex-1 bg-white/60 backdrop-blur-xl border-l border-white/20 flex flex-col items-center justify-center p-12 relative">
        ...
        <div className={`bg-white/50 backdrop-blur-2xl border border-white/80 p-10 rounded-[2.5rem] shadow-2xl w-full max-w-md relative z-10 transition-all duration-500 ${isLoading ? 'opacity-80 scale-95' : 'opacity-100'} hover:border-white transition-colors`}>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <button 
              type="submit" 
              disabled={isLoading} 
              style={{ background: 'rgba(59, 130, 246, 0.2)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', border: '1px solid rgba(255, 255, 255, 0.3)' }}
            ...
            >
              ...
              {isLoading ? (
                ...
                <span className="relative z-10 text-white font-bold text-lg tracking-wide">Masuk Sekarang</span>
              )}
            </button>
          </form>
