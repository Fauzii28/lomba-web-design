      ...
      <div className="max-w-6xl w-full relative z-10 pt-15">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-slate-800 mb-2 relative z-10">Cek Gejala Luar</h2>
            <p className="text-slate-600 mb-4 leading-relaxed h-16 relative z-10 font-medium text-sm">
         ...
         <div 
          ...
          >
            ...
            <div className="bg-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-2 shadow-md group-hover:scale-110 transition-transform relative z-10">
              <MessageSquare className="w-8 h-8 text-white" />
            </div>
            <h2 className="text-2xl font-bold text-slate-800 mb-3 relative z-10">Konsultasi Gejala Dalam</h2>
            <p className="text-slate-600 mb-4 leading-relaxed h-16 relative z-10 font-medium text-md">
        ...
        >
          ...
          <div>
            ...
            <p className="text-slate-700 leading-relaxed font-small opacity-90">
