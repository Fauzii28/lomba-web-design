      ...
      <main className="relative z-10 pt-23 pb-10 px-6 flex justify-center">
        <div className="max-w-2xl w-full bg-white/60 backdrop-blur-md border border-white/80 rounded-[3rem] p-8 md:p-12 shadow-xl">
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full bg-[#1e3a8a] text-white p-5 rounded-3xl font-black text-xs uppercase tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-[#152c6b] transition-all shadow-xl shadow-blue-900/10 mt-6">
              <Save size={18} /> Perbarui Keamanan
            </button>
          </form>
        </div>
      </main>
